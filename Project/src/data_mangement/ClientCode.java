...
public class ClientCode {
	public static void main(String[] args){
		...
		ArrayList<ProviderDataObject> H = new ArrayList<ProviderDataObject>();
...
//<<<<<<< HEAD
		PriorityQueue<Object> hospitals = (PriorityQueue<Object>) ReadExcel.combine.getHospitalsInRange(ReadExcel.combine.tree.keys(1040,1740),57, state);
		...
		hospitals = (PriorityQueue<Object>) ReadExcel.combine.getHospitalsInRange(ReadExcel.combine.tree.keys(1040,1740),57, state);
		while(hospitals.size() != 0){
